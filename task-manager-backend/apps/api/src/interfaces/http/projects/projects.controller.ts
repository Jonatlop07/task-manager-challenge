import { Body, Controller, HttpCode, Post, Headers, Inject } from "@nestjs/common";
import { PROJECT_HTTP_HEADERS, PROJECT_HTTP_RESPONSE_STATUSES, PROJECT_HTTP_ROUTES } from "./projects-http.constants";
import { CreateProjectUseCase } from "@project/application";
import type { CreateProjectCommand, CreateProjectResult } from "@project/application";
import { readHttpHeader, type ApiHttpHeaderMap } from "../shared/api-http-headers";
import { type CreateProjectHttpRequest, parseCreateProjectHttpRequest } from "./projects-http.schema";
